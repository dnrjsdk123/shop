...
//테스트관련 프로퍼티 위치 -> application-test.properties
...
class ItemRepositoryTest {
    ...
    public void createItemTest(){
        ...
        // save -> insert 실행결과가 insert된 item객체가 나옴
    ...
    public void findByItemDetailTestNativeTest(){
        this.createItemList();
    ...
    public void queryDslTest2(){
        ...
        // itemRepository.findAll 모두검색 1 매개 변수 -> 쿼리 조건, 2매개변수, -> 페이지 세팅
